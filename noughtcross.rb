...
class Board 
	...
	def check_3_in_row
		check_array = [] # don't really need to create each time - move to initialize?

		squares.each {|row| check_array.push row} # check rows
		...
		check_array.each do |line|	# check each potential winning line for winner
